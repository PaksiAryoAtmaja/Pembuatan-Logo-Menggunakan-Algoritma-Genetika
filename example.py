...
target_im = imageio.imread('logo teknik unkris.jpg')
...
def callback(ga_instance):
    ...
    if ga_instance.generations_completed % 500 == 0:
        matplotlib.pyplot.imsave('solution_'+str(ga_instance.generations_completed)+'.jpg', gari.chromosome2img(ga_instance.best_solution()[0], target_im.shape))
